...
from tensorflow.python.eager.polymorphic_function.eager_function_run import experimental_functions_run_eagerly
from tensorflow.python.eager.polymorphic_function.eager_function_run import experimental_run_functions_eagerly
