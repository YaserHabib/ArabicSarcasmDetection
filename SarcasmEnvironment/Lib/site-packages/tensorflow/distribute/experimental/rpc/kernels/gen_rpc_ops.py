...
def rpc_server_register(server: _atypes.TensorFuzzingAnnotation[_atypes.Resource], method_name: _atypes.TensorFuzzingAnnotation[_atypes.String], captured_inputs, f, output_specs: str, input_specs:str="", name=None):
  r"""TODO: add doc.
...
def rpc_server_start(server: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None):
  r"""TODO: add doc.
