...
def xla_dynamic_slice_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_XlaDynamicSlice_T], start_indices: _atypes.TensorFuzzingAnnotation[TV_XlaDynamicSlice_Tindices], size_indices: _atypes.TensorFuzzingAnnotation[TV_XlaDynamicSlice_Tindices], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_XlaDynamicSlice_T]:
...
def xla_select_and_scatter(operand: _atypes.TensorFuzzingAnnotation[TV_XlaSelectAndScatter_T], window_dimensions: _atypes.TensorFuzzingAnnotation[TV_XlaSelectAndScatter_Tindices], window_strides: _atypes.TensorFuzzingAnnotation[TV_XlaSelectAndScatter_Tindices], padding: _atypes.TensorFuzzingAnnotation[TV_XlaSelectAndScatter_Tindices], source: _atypes.TensorFuzzingAnnotation[TV_XlaSelectAndScatter_T], init_value: _atypes.TensorFuzzingAnnotation[TV_XlaSelectAndScatter_T], select, scatter, name=None) -> _atypes.TensorFuzzingAnnotation[TV_XlaSelectAndScatter_T]:
