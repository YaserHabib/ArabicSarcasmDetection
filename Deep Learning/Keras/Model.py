...
# fit the model
history = model.fit(tweet_train, labeled_train, batch_size = 32, epochs = 5, validation_data = (tweet_test, labeled_test), verbose = 1, callbacks=[callback]) # type: ignore
...
plt.legend()
plt.savefig(f"Training vs validation accuracy")
...
plt.legend()
plt.savefig(f"Training vs validation loss")
